...
AIGC:
    ...
    ProduceID: 7642208309482733858-data_volume/files/所有对话/主对话/coding-agent_README.md
    ReservedCode1: ""
    ContentPropagator: 001191110102MACQD9K64028705
    PropagateID: 467726794233428#1789983312287
    ReservedCode2: ""
---
# 🤖 Coding Agent
...
[![codecov](https://codecov.io/gh/231dff/coding-agent/branch/main/graph/badge.svg)](https://codecov.io/gh/231dff/coding-agent)
...
它同时提供 **CLI** 与 **Web** 两种交互方式，支持 10+ 模型 Provider，内置隔离的 Docker 沙箱与 55 个领域技能。

```text
$ coding-agent "给 calc.py 的 add 函数补 docstring 并加单元测试"

💭 读取 calc.py              ⚙ read_file  ✓
💭 检查是否已有测试文件       ⚙ glob_files ✓
💭 补 docstring              ⚙ edit_file  ✓
💭 新建测试                  ⚙ write_file ✓
💭 跑测试验证                ⚙ run_tests  ✓
...
- 55 个技能（33 个模型可见 + 22 个内部子文档）：TDD / 代码评审 / 领域建模 / 排查 bug…
...
| `AGENT_EVAL_MODE` | `false` | 评测模式：跳过记忆、检索、状态栏等中间件，最小化 token 与启动开销 |
